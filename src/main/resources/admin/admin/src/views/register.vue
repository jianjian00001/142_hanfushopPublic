  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255,255,255,.5);borderRadius:10px">
        <h1 class="h1" style="color:rgba(251, 0, 29, 0.73);fontSize:28px;">汉服文化平台网站注册</h1>
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://localhost:8080/hanfushop/upload/d5033e16a2ba699952531b67a5573a17.jpg");
		height: 100vh;
		...
		.login-form {
			...
			.rgs-form {
				...
				.btn {
					...
					border-color: rgba(251, 0, 29, 0.73);
					border-radius: 4px;
					background-color: rgba(251, 0, 29, 0.73);
				}
			}
		}
	}
